...
def FL():
    ...
    read_dir_1 = "./ws2-mnist-pytorch/node1/model/"
    read_dir_12 = "./ws2-mnist-pytorch/node2/model/"

    read_dir_13 = "./ws2-mnist-pytorch/node3/model/"
    read_dir_14 = "./ws2-mnist-pytorch/node4/model/"

    read_dir_15 = "./ws2-mnist-pytorch/node5/model/"
...
#   全局
    ...
    read_dir_2 = "./wx-mnist-pytorch/node2/model/"
    read_dir_22 = "./wx-mnist-pytorch/node1/model/"

    read_dir_23 = "./wx-mnist-pytorch/node3/model/"
    read_dir_24 = "./wx-mnist-pytorch/node4/model/"

    read_dir_25 = "./wx-mnist-pytorch/node5/model/"
    ...
    while True:
        ...
        print(model_2_flag,model_1_flag)
...
#         if True :
            ...
            torch.save(model_global.state_dict(), read_dir_12+"net.pkl")
            with open(read_dir_12 + "read_model.txt", "w") as f:
                f.write("True")  # 自带文件关闭功能，不需要再写f.close()

            while True:
                with open(read_dir_12 + "read_model.txt", "r") as f:
                    model_1_flag = f.readline()
                if model_1_flag=="False":
                    break
                else:
            ...
            torch.save(model_global.state_dict(), read_dir_13+"net.pkl")
            with open(read_dir_13 + "read_model.txt", "w") as f:
                f.write("True")  # 自带文件关闭功能，不需要再写f.close()

            while True:
                with open(read_dir_13 + "read_model.txt", "r") as f:
                    model_1_flag = f.readline()
                if model_1_flag=="False":
                    break
                else:
            ...
            torch.save(model_global.state_dict(), read_dir_14+"net.pkl")
            with open(read_dir_14 + "read_model.txt", "w") as f:
                f.write("True")  # 自带文件关闭功能，不需要再写f.close()

            while True:
                with open(read_dir_14 + "read_model.txt", "r") as f:
                    model_1_flag = f.readline()
                if model_1_flag=="False":
                    break
                else:
            ...
            torch.save(model_global.state_dict(), read_dir_15+"net.pkl")
            with open(read_dir_15 + "read_model.txt", "w") as f:
                f.write("True")  # 自带文件关闭功能，不需要再写f.close()

            while True:
                with open(read_dir_15 + "read_model.txt", "r") as f:
                    model_1_flag = f.readline()
                if model_1_flag=="False":
                    break
                else:
            ...
            torch.save(model_global.state_dict(), read_dir_22+"net.pkl")
            with open(read_dir_22 + "read_model.txt", "w") as f:
                f.write("True")  # 自带文件关闭功能，不需要再写f.close()

            while True:
                with open(read_dir_22 + "read_model.txt", "r") as f:
                    model_1_flag = f.readline()
                if model_1_flag=="False":
                    break
                else:
            ...
            torch.save(model_global.state_dict(), read_dir_23+"net.pkl")
            with open(read_dir_23 + "read_model.txt", "w") as f:
                f.write("True")  # 自带文件关闭功能，不需要再写f.close()

            while True:
                with open(read_dir_23 + "read_model.txt", "r") as f:
                    model_1_flag = f.readline()
                if model_1_flag=="False":
                    break
                else:
            ...
            torch.save(model_global.state_dict(), read_dir_24+"net.pkl")
            with open(read_dir_24 + "read_model.txt", "w") as f:
                f.write("True")  # 自带文件关闭功能，不需要再写f.close()

            while True:
                with open(read_dir_24 + "read_model.txt", "r") as f:
                    model_1_flag = f.readline()
                if model_1_flag=="False":
                    break
                else:
                    print("没加载完")
                    time.sleep(2)
            torch.save(model_global.state_dict(), read_dir_25+"net.pkl")
            with open(read_dir_25 + "read_model.txt", "w") as f:
                f.write("True")  # 自带文件关闭功能，不需要再写f.close()

            while True:
                with open(read_dir_25 + "read_model.txt", "r") as f:
                    model_1_flag = f.readline()
                if model_1_flag=="False":
                    break
                else:
